...
export function buildFixture(
  ...
  return {
    ...
    ...(categoriaConfig.color_fondo ? {
      color_fondo: categoriaConfig.color_fondo,
      color_borde: categoriaConfig.color_borde,
      color_texto: categoriaConfig.color_texto,
    } : {}),
...
export function buildDesafioFixture(
  ...
  return {
    ...
    sexo: cat.sexo,
    ...(cat.color_fondo ? { color_fondo: cat.color_fondo, color_borde: cat.color_borde, color_texto: cat.color_texto } : {}),
    grupos: [],
    faseEliminatoria: [],
    consola: [],
    partidos,
