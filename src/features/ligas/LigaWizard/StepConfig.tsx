...
export default function StepConfig() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <Label className="text-xs font-semibold uppercase tracking-wide mb-3 block text-slate">Formato</Label>
        ...
        {errors.formato && <p className="text-[#BA1A1A] text-sm mt-1">{errors.formato.message}</p>}
      </div>
