    ...
    <div className="space-y-4">
      ...
      {!temporadas || temporadas.length === 0 ? (
        <div className="rounded-xl bg-white shadow-card p-8 text-center">
          <p className="font-inter text-sm text-muted">Sin temporadas registradas.</p>
        </div>
      ) : (
            ...
            >
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <button
                  ...
                  aria-label={`Amistosos afectan ranking en ${t.nombre}`}
                  ...
                  className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-gold/50 disabled:opacity-50 ${
                    t.amistosos_afectan_ranking ? 'bg-gold' : 'bg-slate/30'
                  }`}
                >
